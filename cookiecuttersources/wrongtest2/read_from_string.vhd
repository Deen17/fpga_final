...
architecture behav of read_from_string is 
    ...
    "read_from_string,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.081750,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=342,HLS_SYN_LUT=700}";
...
begin
    ...
    tmp_fu_294_p2 <= "1" when (unsigned(z_reg_211) < unsigned(ap_const_lv7_6E)) else "0";
