...
entity read_from_string_cud_ram is 
    generic(
...
architecture rtl of read_from_string_cud_ram is 
...
architecture arch of read_from_string_cud is
    component read_from_string_cud_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    read_from_string_cud_ram_U :  component read_from_string_cud_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
